...
describe('GET /users/me', () => {
  it('should return user if authenticed', done => {
    request(app)
      .get('/users/me')
  ...
  it('should return 401 if not authenticed', done => {
    request(app)
      .get('/users/me')
      .expect(401)
      .expect(res => {
...
describe('POST /users', () => {
  ...
  it('should return validation errors if request invalid', done => {
    var invalidEmail = ';kjklj';
    var invlaidPassword = '123';

    request(app)
      .post('/users')
      .send({ invalidEmail, invlaidPassword })
      .expect(400)
      .end(done);
  });
